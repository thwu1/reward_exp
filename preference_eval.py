...
with open("/data/tianhao/reward_bootstrap/dataset_old/preference/preference_benchmark.json", "r") as f:
    data = json.load(f)
...
while idx < len(data):
    ...
    rewards.append(r)
    if idx % 100 == 0:
        json.dump(rewards, open("preference_rewards.json", "w"))
